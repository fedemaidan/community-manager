...
class Post  implements TaggeableInterface {
    ...
    /**
     * Set stringDeBusqueda
     *
     * @param string $stringDeBusqueda
     * @return Post
     */
    public function setStringDeBusqueda($stringDeBusqueda)
    {
        $this->stringDeBusqueda = $stringDeBusqueda;

        return $this;
    }

    /**
     * Get stringDeBusqueda
     *
     * @return string 
     */
    public function getStringDeBusqueda()
    {
        return $this->stringDeBusqueda;
    }
